...
Hypothèses :
  ...
  - Infiltration potentielle = loi HSM (X_begin / X_end).
...
def main():
    ...
    Seep_mm_5 = seep_loss * 1000.0    # [m] -> [mm/pas]
    ET_mm_5   = sa_loss   * 1000.0    # [m] -> [mm/pas]
    ...
    if q_obs_plot is not None:
        ...
        ax4.plot(t_plot, q_mod_plot, label="Q_mod (r_rate * A)", linewidth=1.2)
